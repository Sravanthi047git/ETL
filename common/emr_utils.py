from code.common.system_utils import read_file,generate_uuid
from code.common.s3_utils import upload_file, delete_file
from code.common.ssh_utils import execute_remote
...
def run_on_hive(script_path, run_date, pem_file_path, emr_master_ip, emr_username='hadoop'):
    ...
    s3_path = 's3://twinkle-de-playground/scripts/' + generate_uuid() + '.hql'
    ...
    print('Parameters passed to the execute remote function are:', pem_file_path, emr_master_ip, emr_username, cmd_arr )
